...
<span class="head-tp">Pay with Google Pay</span>
	<input type="hidden" name="payop" value="tez_pwa"/>
	<input type="hidden" name="bankCode" value=""/>
	<input type="hidden" id="iframeEnabledFor-tez" value=""/>
	<input type="hidden" id="iframeEnabledFor-tez-bank" value=""/>
	<div class="">
		<label for="pwapayerVAMobile" class="cpmt_cardNameLabel">Enter mobile number linked with Google Pay</label>
		<input type="text" autocomplete="off" data-msginfo="* required|Enter Valid Mobile Number" data-validation="required|checkVAMobile" name="payerVAMobile" id="pwapayerVAMobile" class="w300 ie6Input">
