...
<div id="my-booking-reset-pass" style="display:none;">
	...
	<section class="col-md-7">
		...
		<div class="panel panel-default clearfix text-md my-book">
			...
			<div class="panel-body pd-bottom">
				...
				<form name="qb_reset_pass_form" id = "qb_reset_pass_form_id" action="/PaySwift/update-password.htm" class="yt-form" role="form" autocomplete="off">
