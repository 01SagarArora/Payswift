...
<div class="corp-qb-box row" id="corp-not-logged-in" style="display:none;">
		...
		<div class="panel panel-default clearfix text-md my-book">
			...
			<div class="panel-body pd-bottom">
				...
				<div class="col-md-offset-1 my-btn-group clearfix">
					<div class = "qb_error_msg" style ="margin-bottom:10px; color:red; display:block;"><yatra:languageTag content="Please login to use Quick Book" language="${language}"/>.</div>
				</div>
